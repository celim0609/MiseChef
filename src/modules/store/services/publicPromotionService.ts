...
export type PublicPromotion = { productId: string; name: string; type: 'percentage' | 'fixed_amount' | 'buy_x_get_y'; savings: number; terms: Record<string, number>; originalPrice: number; estimatedPrice: number | null };
