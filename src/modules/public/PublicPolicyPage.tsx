...
const BusinessIdentity = () => (
  <div className="rounded-2xl border border-surface-container-high bg-surface-container-low p-5 font-sans text-sm font-bold leading-7 text-on-surface-variant">
    ...
    <p>Telephone / WhatsApp: <a className="text-primary underline" href="tel:+60164209116">016-420 9116</a></p>
  </div>
);
...
const terms: PolicyDocument = {
  ...
  sections: [
    ...
    { title: '5. Prices & Charges', body: <>Prices are displayed in Malaysian Ringgit (MYR/RM). The total payable amount, including applicable charges, is shown before Order confirmation. We may correct genuine pricing or listing errors. If a material pricing error affects a paid Order that we cancel, an appropriate refund will be arranged.</> },
    ...
    { title: '9. Changes, Cancellations & Refunds', body: <>Requests to modify or cancel should be made as soon as possible by contacting 016-420 9116. Once preparation has commenced, change-of-mind modification or cancellation may no longer be possible. Refunds, cancellations, incorrect Orders, missing Products and other Order problems are governed by our Refund & Cancellation Policy. Nothing limits consumer rights that cannot lawfully be excluded.</> },
...
const refund: PolicyDocument = {
  ...
  intro: <>This Policy applies to orders placed through MiseChef, operated by CL WISE EMPIRE (003882452-K). It forms part of our Terms & Conditions and should be read together with our Payment Policy and Pickup & Order Fulfilment Policy.</>,
  sections: [
    { title: '1. How to Cancel', body: <>Contact us as soon as possible at 016-420 9116 (Phone/WhatsApp) and provide your Order Number. Before preparation starts, we will normally try to accommodate a reasonable cancellation or modification request; an eligible paid Order cancelled before preparation begins will receive a full refund. Once preparation starts, a change-of-mind cancellation, modification or refund may no longer be accepted because ingredients, preparation time and labour may already have been committed. This does not affect consumer rights that cannot lawfully be excluded.</> },
    { title: '2. When You May Be Eligible for a Remedy', body: <>Contact us promptly if you receive the wrong Product, a paid Product is missing, a Product is materially different from what was ordered, there is a significant quality or food-safety issue, we cannot supply a paid Product, or you were charged incorrectly. Depending on the circumstances, a remedy may include correction, replacement, partial or full refund, or another reasonable resolution. We may reasonably request your Order Number, issue details, photographs or other relevant information.</> },
    { title: '3. Change-of-Mind Refunds', body: <>A refund is generally not available solely because you ordered the wrong Product or quantity, supplied incorrect Order information, changed your mind after preparation started, or collected substantially later than the confirmed pickup time and the issue resulted from that delay. Each case will be assessed under applicable Malaysian consumer law.</> },
    ...
    { title: '8. Consumer Rights', body: <>Nothing in this Policy excludes, restricts or modifies any consumer right, guarantee or remedy that cannot lawfully be excluded under the Consumer Protection Act 1999 or other applicable Malaysian law. Mandatory law prevails where it conflicts with this Policy.</> },
    contactSection
  ]
};
...
const payment: PolicyDocument = {
  ...
  sections: [
    { title: '1. Currency', body: <>All prices are stated in Malaysian Ringgit (MYR/RM). The total amount payable is displayed before Order confirmation.</> },
    { title: '2. Payment Methods', body: <>Available methods are displayed at checkout and may include manual QR payment, bank transfer, supported e-wallet payment and an integrated third-party payment gateway. Not every method is available at all times.</> },
    ...
    { title: '10. Contact for Payment Issues', body: <><BusinessIdentity /><p className="mt-4">Please provide your Order Number and, where relevant, the transaction reference. Never send us your password, PIN or OTP.</p></> }
  ]
};
...
const contact: PolicyDocument = {
  ...
  intro: <>Need help with an order? Please provide your Order Number for faster assistance.</>,
  sections: [
    { title: 'Customer Support', body: <BusinessIdentity /> },
